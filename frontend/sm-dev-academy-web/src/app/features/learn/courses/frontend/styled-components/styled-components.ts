...
@Component({
  ...
  templateUrl: './styled-components.html',
  // styleUrl: './styled-components.scss', -> usando o global!
})
export class StyledComponents implements OnInit, AfterViewInit {
        ...
        next: (response) => {
          ...
          this.courses =
            response.courses.filter(
              (course) =>
                course.technology === 'Styled-Components',
            );
