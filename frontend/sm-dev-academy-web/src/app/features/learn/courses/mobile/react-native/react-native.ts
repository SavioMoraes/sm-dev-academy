...
@Component({
  ...
  templateUrl: './react-native.html',
  // styleUrl: './react-native.scss', -> usando o global!
})
export class ReactNative implements OnInit, AfterViewInit {
        ...
        next: (response) => {
          ...
          this.courses =
            response.courses.filter(
              (course) =>
                course.technology === 'React Native',
            );
